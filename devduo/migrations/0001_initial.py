    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mentee', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='devduo.user')),
                ('mentor', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='devduo.mentor')),
            ],
        ),
    ]
